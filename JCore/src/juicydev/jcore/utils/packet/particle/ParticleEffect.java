...
public enum ParticleEffect {
	...
	CLOUD("cloud"),
	/**
	 * @appearance Little coloured clouds
	...
	static {
		...
		try {
			packetPlayOutWorldParticles = ReflectionUtil.getConstructor(
