...
public class IconCrackData extends ParticleEffectData {
	...
	public IconCrackData(int id, float offsetX, float offsetY, float offsetZ,
	...
	public static IconCrackData fromString(String s)
			throws IllegalArgumentException {
		if (!s.matches(FORMAT))
			throw new IllegalArgumentException("Invalid format");
		String[] p = s.split("@");
		return new IconCrackData(Integer.parseInt(p[0]),
	...
	public void displayEffect(Location center, Player... players) {
		ParticleEffect.displayIconCrack(center, id, offsetX, offsetY, offsetZ,
				speed, amount, players);
	}
	...
	public void displayEffect(Location center, double range) {
		ParticleEffect.displayIconCrack(center, range, id, offsetX, offsetY,
